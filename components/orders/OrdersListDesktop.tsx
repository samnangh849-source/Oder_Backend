                ...
                {visibleCols.map((k: string) => {
                    ...
                    const content = (() => {
                        switch (k) {
                            ...
                            case 'productInfo':
                                return (
                                    <div className="px-6 py-2 w-full overflow-hidden flex items-center">
                                        <div className="flex -space-x-3 hover:space-x-1 transition-all duration-500 items-center">
                                            {productThumbnails.slice(0, 3).map((p: any, i: number) => (
                                                <div key={i} className="relative group/prod">
                                                    <div className="w-11 h-11 rounded-xl bg-gray-800 border-2 border-[#020617] overflow-hidden shadow-lg transition-transform group-hover/prod:scale-110 group-hover/prod:z-10">
                                                        {p.img ? <img src={p.img} className="w-full h-full object-cover" alt="" /> : <div className="w-full h-full flex items-center justify-center text-[8px] text-gray-500">N/A</div>}
                                                    </div>
                                            ...
                                            <div className="ml-4 flex flex-col justify-center max-w-[140px]">
                                                ...
                                                {order.Products.length > 1 && <span className="text-[9px] font-bold text-gray-500 mt-0.5">and {order.Products.length - 1} more</span>}
                                            </div>
                                        </div>
                                    </div>
                                );
                            ...
                            case 'pageInfo':
                                return (
                                    <div className="px-4 py-2 w-full overflow-hidden flex items-center gap-3">
                            ...
                            case 'note':
                                return <div className="px-4 py-2 w-full text-[12px] text-gray-500 font-medium truncate italic flex items-center group-hover:text-gray-300 transition-colors">{order.Note || '---'}</div>;
                            case 'print':
                                return (
