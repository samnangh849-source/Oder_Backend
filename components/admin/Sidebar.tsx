...
const Sidebar: React.FC<SidebarProps> = ({
    ...
    const { 
        ...
        language, setLanguage, showNotification, hasPermission
    ...
    const reportSections = [
        { id: 'overview', title: t.overview, icon: '📊', permission: 'view_revenue' },
        { id: 'sales_team', title: t.sales_team_report, icon: '👥', permission: 'view_revenue' },
        { id: 'sales_page', title: t.sales_page_report, icon: '📄', permission: 'view_revenue' },
        { id: 'performance', title: t.performance, icon: '📈', permission: 'view_team_leaderboard' },
        { id: 'profitability', title: t.profitability, icon: '💰', permission: 'view_revenue' },
        { id: 'forecasting', title: t.forecasting, icon: '🔮', permission: 'view_revenue' },
        { id: 'shipping', title: t.shipping_report, icon: '🚚', permission: 'view_revenue' },
    ].filter(s => !s.permission || hasPermission(s.permission));

    const navItems = [
        { id: 'dashboard', label: t.dashboard, icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z" /></svg>, component: 'admin', permission: null },
        { id: 'fulfillment', label: 'Fulfillment', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" strokeWidth={2} /></svg>, component: 'fulfillment', permission: null },
        { id: 'packaging', label: 'Packaging', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" /></svg>, component: 'packaging', permission: null },
