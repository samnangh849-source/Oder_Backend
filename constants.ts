...
export const SOUND_URLS = {
    ...
    NEW_ORDER_VOICE_ACC: 'https://res.cloudinary.com/dhobzwi7h/video/upload/v1777799090/NEW_ORDER_VOICE_vtzvx7.mp3',
    NEW_ORDER_VOICE_FLEXI: 'https://res.cloudinary.com/dhobzwi7h/video/upload/v1778504839/Dit_Way_cqfuyd.mp3',
};
