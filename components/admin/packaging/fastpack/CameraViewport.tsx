        ...
        <div className="bg-[#181A20] rounded-sm p-6 border border-[#2B3139] flex-grow flex flex-col relative overflow-hidden">
            ...
            <div className="relative flex-grow min-h-[400px]">
                {previewImage ? (
                    ...
                    <button onClick={startCamera} className="w-full h-full border border-dashed border-[#2B3139] rounded-sm flex flex-col items-center justify-center gap-6 hover:border-[#FCD535]/50 bg-[#0B0E11] transition-colors">
                        <div className="w-16 h-16 bg-[#181A20] rounded-sm flex items-center justify-center text-[#FCD535] border border-[#2B3139]">
                        ...
                        <div className="text-center">
                            <p className="text-sm font-bold text-gray-200 uppercase tracking-widest">Activate Camera</p>
                            <p className="text-[#FCD535] text-[9px] font-bold uppercase tracking-widest mt-1">Ready for capture sequence</p>
                        </div>
                    </button>
                )}
            </div>
