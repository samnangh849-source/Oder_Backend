            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div className="flex-grow flex justify-between items-center bg-slate-900/60 p-4 rounded-3xl border border-white/5 backdrop-blur-xl">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-xl font-black text-white uppercase tracking-tight">{project.name || (project as any).projectName}</h2>
                            <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-0.5">{t.incentives} | {t.data_source}: {project.dataSource}</p>
                        </div>
                    </div>
