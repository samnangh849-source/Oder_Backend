                            ...
                            {loadingActionId === order['Order ID'] && (
                                            ...
                                            <div className="px-2 pb-2">
                                                ...
                                                <div className="mt-2.5 flex flex-col gap-1 mb-2.5">
                                                    ...
                                                    {activeTab === 'Pending' && (
                                                        <div className="flex items-center gap-1.5 mt-1 bg-white/5 px-2 py-0.5 rounded-sm w-fit border border-white/5">
                                                    ...
                                                    {activeTab === 'Ready to Ship' && order['Packed Time'] && (
                                                        <div className="flex items-center gap-1.5 mt-1 bg-[#0ECB81]/5 px-2 py-0.5 rounded-sm w-fit border border-[#0ECB81]/10">
                                                    ...
                                                    {activeTab === 'Shipped' && order['Dispatched Time'] && (
                                                        <div className="flex items-center gap-1.5 mt-1 bg-blue-500/5 px-2 py-0.5 rounded-sm w-fit border border-blue-500/10">
